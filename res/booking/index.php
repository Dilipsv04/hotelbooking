...
if(isset($_POST['submit'])){
    ...
    if ($query) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'your_email@yourdomain.com'; // Replace with your email
            $mail->Password = 'your_email_password'; // Replace with your email password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;

            $mail->setFrom('your_email@yourdomain.com', 'Restaurant Name');
            ...
            $mail->Body = "<h2>Booking Confirmed</h2>
                           ...
                           <ul>
                               <li>Booking Number: $bno</li>
                               <li>Date: $bookingdate</li>
                               <li>Time: $bookingtime</li>
                               <li>Adults: $noadults</li>
                               <li>Children: $nochildrens</li>
                           </ul>
